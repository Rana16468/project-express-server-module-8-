...
router.post('/change-password',auth(USER_ROLE.admin,USER_ROLE.user,USER_ROLE.faculty,USER_ROLE.superAdmin),validateRequest(AuthAvalidation.changePasswordValidationSchema),LoginUserController.changePassword)
